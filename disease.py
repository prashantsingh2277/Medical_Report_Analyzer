...
def PredictDisease(report):
    if api_key:
        formatted_question = (report + f"consider this medical report and provide the List of all posibble diseases it indicates"
                              f"Just give one-linear explanation for each disease predicted."
                              )
